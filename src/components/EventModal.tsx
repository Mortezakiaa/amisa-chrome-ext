...
import { EventSelector, modalHandler, setEventReminderTime, setEventTitle, setOnEditMode } from "../statemanagment/slices/Event";
          ...
          <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="flex items-center justify-between p-2 border-b rounded-t dark:border-gray-600">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{editOrDeleteMode ? "ویرایش رویداد" : "اضافه کردن رویداد"}</h3>
                <button
                  onClick={() => {
              ...
              <div className="flex gap-2 items-center p-2 border-t border-gray-200 rounded-b dark:border-gray-600 ">
                ...
                <AddButton eventHandler={eventHandler} editOrDeleteMode={editOrDeleteMode} />
                {editOrDeleteMode ? (
